...
class TestPNGGeneration:
    ...
    def test_long_text_18mm(self):
        ...
        png, spec = create_label_png("This is a longer text", 45, "W18", 20)
...
class TestBrotherRasterOutput:
    ...
    def test_6mm_black_tape_raster(self):
        ...
        matrix = png_to_bw_matrix(png)
        raster = convert_to_brother_raster(matrix, spec, hi_res=True, feed_mm=1)
    ...
    def test_different_feed_margin(self):
        ...
        matrix = png_to_bw_matrix(png)
        raster = convert_to_brother_raster(matrix, spec, hi_res=True, feed_mm=2)
